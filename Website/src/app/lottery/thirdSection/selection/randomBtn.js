...
export default function RandomBtn() {
  ...
  return (
    <div className="btnText w-full grid grid-cols-2 mx-auto gap-1 sm:gap-3 smallTextSize  p-2 xl:p-0">
      <div className="w-full grid grid-cols-5 gap-1 sm:gap-2">
        ...
        <button
          onClick={inc}
          className="infoText w-full lottoBtn normalTextSize"
        >
          +
        </button>
        <button
      ...
      <div className="grid grid-cols-2 w-full gap-1 sm:gap-3">
        <button
          ...
          className="lottoBtn  p-2 tableTextSize"
        >
          ADD
        </button>
        <button
          onClick={mxsRandomGenerator}
          className="lottoBtn  p-2 tableTextSize"
        >
          MAX
        </button>
