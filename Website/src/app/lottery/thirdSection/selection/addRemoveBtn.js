...
const AddRemoveBtn = () => {
  ...
  return (
    <div className=" w-full grid grid-cols-2 gap-3 p-2 xl:p-0">
      <button className="btnText lottoBtn p-2" onClick={add}>
        Add
      </button>
      <button className="btnText lottoBtn" onClick={remove}>
        Remove
      </button>
    </div>
  );
